  ...
  if (isVisible) {
    ...
    return (
      <section className="edu visible">
        <button onClick={() => onToggleView('skills')}>
          <h3>Skills</h3>
            ...
            if (index == editingIndex) {
              ...
              return (
                <div key={school.id} className="eduEdit eduListItem">
                  ...
                  <div className="eduGroup">
                    <label htmlFor="eduSchool">Skill</label>
                    <input
                      type="text"
                      name="eduSchool"
                      id="eduSchool"
                  ...
                  <div className="eduBtnCtn">
                    <button className="eduDelete" onClick={() => onDelete('skills', index)}>
                      <div className="fieldIcon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                          <path
                            fill="currentColor"
                    ...
                    <div className="eduActionButtons">
                      <button
                        className="eduCancel"
                        onClick={() => onToggleEdit('skills', index)}
                      >
                        Cancel
                      </button>
                      <button className="eduAdd" onClick={() => onToggleEdit('skills', index)}>
                        <div className="fieldIcon">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path
                              fill="currentColor"
              ...
              return (
                <li key={school.id} className="eduListItem">
                  <button className="proListBtn" onClick={() => onToggleEdit('skills', index)}>
                    <span className="eduListSch">{school.skill}</span>
                  </button>
                </li>
              );
            }
